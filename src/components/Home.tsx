        ...
        <Container fluid="xxl">
            <div>
                ...
                <dl>
                    ...
                    <dd>Базовую адаптацию под мобильные телефоны и планшеты</dd>
                    ...
                    <dd>Личный кабинет пользователя: профиль(ФИО, возраст), Антропометрические данные(рост, вес), программа тренировок имеет демонстрационный вид(как будет выглядеть после реализации добавления тренировок из списка).</dd>
                </dl>
                <dl>
                    <dt>Дальнейшие планы:</dt>
                    <dd>Работа с версткой и внешним видом приложения</dd>
                    <dd>Добавить в личный кабинет: вкладку параметры тела(замеры талии, бедер и тд), прогресс тренировочный с возможностью следить за прогрессом по упражнениям, по параметрам тела и весу</dd>
