...
const CalorieCalculator = () => {
    ...
    const renderResult = () => {
        return (
            <>
                <p>Для достижения вашей цели суточная калорийность должна состовлять {result.calories} ккал в день. </p>
                ...
                <Button onClick={calculateAgain} variant="primary" type="submit">
                    Рассчитать заново
                </Button>
            </>
        )
    ...
    return (
        <Container fluid="xxl">
            <div className='calorieCalculator'>
                ...
                <div className='col-5'>
                    {(mode === 'input') ? renderDataInput() : renderResult()}
                </div>
            </div>
        </Container>
    );
