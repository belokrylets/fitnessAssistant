...
const muscleGroups = [
    ...
    {
        id: 7, value: 'trapezius', rus: "Трапеции", exercises: [
            { id: 801, place: 'gym', name: 'Шраги с гантелями стоя', description: 'Исходное положение: стоя с гантелями, руки вдоль корпуса. При выдохе поднимаем плечи вверх насколько это возможно, задержка на секунду, при вдохе опускаем плечи.', img: '' },


        ]
    },
    {
        id: 8, value: 'press', rus: "Пресс", exercises: [
            { id: 901, place: 'home', name: 'Планка', description: 'Исходное положение: две точки опоры на полу - локти и стопы. Верхняя часть рук в этом положении - перпендикулярно полу, колени прямые, корпус - параллельно полу.', img: '' },
            { id: 902, place: 'home', name: 'Боковая планка', description: 'Исходное положение: лежа на боку, упор - на локоть одной руки, перпендикуряной полу, вторая рука - вдоль корпуса, колени и бедра прямые, одна нога лежит на другой.', img: '' },
            { id: 903, place: 'home', name: 'Подъем ног или коленей', description: 'Исходное положение: спина плотно прижата к спинке стула. Ноги прямые в коленях, чуть поданы вперед, перед корпусом. На выдохе - поднимаем ноги, сгибая в коленях, не отрывая поясницу от спинки. На вдохе - опускаем ноги в исходное положение.', img: '' },
            { id: 904, place: 'home', name: 'Скручивания в стороны поочередно на наклонной скамье', description: 'Исходное положение: закрепляем ноги на наклонной скамье, спина округлена. На вдохе опускаем спину, но не касаемся лавки, на выдохе поднимаем корпус и одновременно разворачиваемся вбок. Развороты корпуса делаем поочередно в разные стороны.', img: '' },
